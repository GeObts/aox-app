...
exports.ERC8004_CHAINS = exports.ERC8004_TESTNET_CONTRACTS = exports.ERC8004_MAINNET_CONTRACTS = void 0;
exports.getErc8004Chain = getErc8004Chain;
exports.getErc8004Contracts = getErc8004Contracts;
exports.listErc8004ChainIds = listErc8004ChainIds;
// =============================================================================
// Contract Addresses
// =============================================================================
...
exports.ERC8004_TESTNET_CONTRACTS = {
...
exports.ERC8004_CHAINS = {
    ...
    1: {
        ...
        contracts: exports.ERC8004_MAINNET_CONTRACTS,
    },
    8453: {
        chainId: 8453,
        network: "base",
    ...
    11155111: {
        ...
        contracts: exports.ERC8004_TESTNET_CONTRACTS,
    },
    84532: {
        chainId: 84532,
 ...
 * ```
 */
function getErc8004Chain(chainId) {
    return exports.ERC8004_CHAINS[chainId];
}
/**
 ...
 * ```
 */
function getErc8004Contracts(chainId) {
    const chain = exports.ERC8004_CHAINS[chainId];
    if (!chain) {
        throw new Error(`ERC-8004 contracts are not configured for chain ID ${chainId}. ` +
            `Supported chains: ${Object.keys(exports.ERC8004_CHAINS).join(", ")}`);
    }
 ...
 * ```
 */
function listErc8004ChainIds(filter) {
    return Object.values(exports.ERC8004_CHAINS)
        .filter((chain) => {
        if (filter === "mainnet")
